...
getAddExpInc() { 
 ...
 let addExpenses1 = additionalExpensesItem.value.split(',');
    ...
    additionalIncomeItem.forEach(countAdd);
    this.addIncome.push(additionalIncomeItem);

    addExpenses1.forEach(countAdd);
    this.addExpenses.push(addExpenses1);
